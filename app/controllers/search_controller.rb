class SearchController < ApplicationController
  ...
  def search
    ...
    if(query_parameters[:q] || query_parameters[:theme] || query_parameters[:country] || query_parameters[:region])
      ...
      respond_with(error_message("You have not included any search parameters.  You must include at least one search parameter of 'q', 'theme', 'region' or 'country'."), :status => 400)
    end
