...
class ResearchOutputService < AbstractService
  ...
  def get details, opts
    ...
    base_url = Rails.application.routes.url_helpers.get_research_outputs_url(@type, {:host => opts[:host], :format => @format, :detail => @detail, :id => details[:id]})
  ...
  def get_all details, opts
    ...
    base_url = Rails.application.routes.url_helpers.get_all_research_outputs_url(@type, {:host => opts[:host], :format => @format, :detail => @detail})
